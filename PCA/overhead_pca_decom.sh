...
/home/luo/Tao/LossyCompressStudy/zfp/examples/zfp -p $err -s -d -1 $size -z base.zfp -z base.zfp.out
...
/home/luo/Tao/LossyCompressStudy/zfp/examples/zfp -p $err -s -d -1 $size -z low_base.zfp -z low_base.zfp.out
#/home/luo/Tao/LossyCompressStudy/SZ/example/testdouble_compress sz.config low_base  $size
#/home/luo/Tao/LossyCompressStudy/SZ/example/testdouble_decompress sz.config low_base.sz  $size
...
/home/luo/Tao/LossyCompressStudy/zfp/examples/zfp -p $err -s -d -1 $size -z delta.zfp -z delta.zfp.out
