...
for filename in list1:
	...
	fin.close()
        ...
        SVD_cmd="python SVD.py "+ "Inputdata/"+filename+".dat" 
        os.system(SVD_cmd)
        ...
        szcmpresscmd = '/home/luo/Tao/LossyCompressStudy/SZ/example/testdouble_compress sz.config delta '+str(row*col)
        szdecmp = '/home/luo/Tao/LossyCompressStudy/SZ/example/testdouble_decompress sz.config delta.sz '+str(row*col)
